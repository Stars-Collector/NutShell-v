...
module EmbeddedTLBExec_1(	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:177:7
  ...
  wire        hitLoad =
    hitCheck & (_hitMeta_T_10[1] | io_pf_status_mxr & _hitMeta_T_10[3]);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/EmbeddedTLB.scala:222:38, :231:86, :234:{41,55,72}
  wire        _loadPF_T_9 =
  ...
  wire        _storePF_T_13 =
    ...
    & ~(io_in_bits_cmd[0]) & ~(io_in_bits_cmd[3]) & hit & isAMO__bore;	// src/main/scala/bus/simplebus/SimpleBus.scala:73:{18,29,33}, :74:22, src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/EmbeddedTLB.scala:210:25, :222:38, :231:86, :234:41, :235:42, :247:15, :248:{17,44,52,88}
  ...
  wire        _GEN_5 =
    ...
    | ~(permCheck & io_mem_resp_bits_rdata[2]) & io_in_bits_cmd[0];	// src/main/scala/bus/simplebus/SimpleBus.scala:73:{18,29,33}, :74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:298:44, :320:86, :323:{47,62,79}, :324:48, :337:{19,29,46,50,61}
              ...
              state <=
                _GEN_5
                  ...
                  : ~(io_mem_resp_bits_rdata[6]) | ~(io_mem_resp_bits_rdata[7])
                    & io_in_bits_cmd[0]
                      ? 3'h3
                      : 3'h4;	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/nutcore/mem/EmbeddedTLB.scala:253:22, :278:15, :298:44, :305:73, :325:{60,72,76,88}, :337:{46,80}, :338:21, :342:{21,27}
          end
        end
