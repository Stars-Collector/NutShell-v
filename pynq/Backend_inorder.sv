...
module Backend_inorder(	// src/main/scala/nutcore/backend/ooo/Backend.scala:668:7
  ...
  output        io_redirect_valid,	// src/main/scala/nutcore/backend/ooo/Backend.scala:669:14
                wbu_io_in_valid__bore,
  output [63:0] wbu_io_wb_rfData__bore,
                exu_csr_satp__bore,
  ...
  output [63:0] exu_csr_perfCnts_2__bore,
  ...
  output [4:0]  wbu_io_wb_rfDest__bore,
  ...
  output [38:0] wbu_io_in_bits_decode_cf_pc__bore,
  output [11:0] exu_csr__WIRE__bore,
                exu_csr__WIRE__bore_0,
  output        wbu_io_wb_rfWen__bore
);
  ...
  wire        _wbu_io_in_valid__bore_0;	// src/main/scala/nutcore/backend/ooo/Backend.scala:680:20
  ...
  EXU exu (	// src/main/scala/nutcore/backend/ooo/Backend.scala:679:20
    ...
    .csr_perfCntCond_2__bore               (_wbu_io_in_valid__bore_0),	// src/main/scala/nutcore/backend/ooo/Backend.scala:680:20
    ...
    .csr_perfCnts_2__bore                  (exu_csr_perfCnts_2__bore),
  ...
  WBU wbu (	// src/main/scala/nutcore/backend/ooo/Backend.scala:680:20
    ...
    .io_in_valid__bore                    (wbu_io_in_valid__bore),
    .io_wb_rfData__bore                   (wbu_io_wb_rfData__bore),
    .falseWire__bore                      (_wbu_falseWire__bore),
    .io_in_valid__bore_0                  (_wbu_io_in_valid__bore_0),
    .io_wb_rfDest__bore                   (wbu_io_wb_rfDest__bore),
    .io_in_bits_decode_cf_pc__bore        (wbu_io_in_bits_decode_cf_pc__bore),
    .io_wb_rfWen__bore                    (wbu_io_wb_rfWen__bore)
  );
endmodule
