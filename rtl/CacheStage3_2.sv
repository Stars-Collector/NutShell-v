...
module CacheStage3_2(	// src/main/scala/nutcore/mem/Cache.scala:235:14
  ...
  wire [11:0] _dataWriteArb_io_out_bits_setIdx;	// src/main/scala/nutcore/mem/Cache.scala:255:28
  ...
  wire [8:0]  _metaWriteArb_io_out_bits_setIdx;	// src/main/scala/nutcore/mem/Cache.scala:254:28
  wire [16:0] _metaWriteArb_io_out_bits_data_tag;	// src/main/scala/nutcore/mem/Cache.scala:254:28
  ...
  wire [63:0] _dataReadArray_T_10 =
    ...
    | (io_in_bits_waymask[3] ? io_in_bits_datas_3_data : 64'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, src/main/scala/nutcore/mem/Cache.scala:252:14
  wire [63:0] dataRead =
  ...
  wire [63:0] dataHitWriteBus_x1_data =
    io_in_bits_req_wdata & wordMask | dataRead & ~wordMask;	// src/main/scala/nutcore/mem/Cache.scala:275:21, :276:21, src/main/scala/utils/BitUtils.scala:34:{14,26,37,39}
  wire [11:0] dataHitWriteBus_x3 =
  ...
  wire [31:0] io_mem_req_bits_addr_0 =
    _io_mem_req_valid_T
      ...
      : {metaHitWriteBus_x8_tag, io_in_bits_req_addr[14:6], 6'h0};	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/Cache.scala:258:31, :318:{35,44}, :321:18, :322:23, :324:35
  wire [3:0]  io_mem_req_bits_cmd_0 = {1'h0, cmd};	// src/main/scala/bus/simplebus/SimpleBus.scala:65:14, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :322:16
  ...
  wire        _GEN_1 = _io_out_valid_T_8 & io_mem_resp_valid;	// src/main/scala/nutcore/mem/Cache.scala:338:68, :422:37
  wire        _GEN_2 = _GEN_1 & _io_out_valid_T_11;	// src/main/scala/bus/simplebus/SimpleBus.scala:76:27, src/main/scala/nutcore/mem/Cache.scala:422:{37,57}
  wire        _GEN_3 = hitReadBurst & _io_dataReadRespToL1_T_2;	// src/main/scala/nutcore/mem/Cache.scala:263:26, :306:66, :430:30
  wire [63:0] io_out_bits_rdata_0 =
    _GEN_2
      ? dataRefill
      : _dataHitWriteBus_x3_T_1 | _dataHitWriteBus_x3_T
          ? (hit ? dataRead : inRdataRegDemand)
          : _GEN_3 ? _dataHitWay_T_10 : hit ? dataRead : inRdataRegDemand;	// src/main/scala/bus/simplebus/SimpleBus.scala:78:27, src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/Cache.scala:260:25, :275:21, :279:32, :339:35, :422:{57,79}, :424:25, :426:{35,75}, :428:{25,31}, :430:{30,54}, :432:25, :435:{25,31}, src/main/scala/utils/BitUtils.scala:34:26
  wire [3:0]  io_out_bits_cmd_0 =
    _GEN_2
      ? {1'h0, _io_out_bits_cmd_T, 2'h2}
      : _GEN_3 ? {1'h0, respToL1Last, 2'h2} : io_in_bits_req_cmd;	// src/main/scala/bus/simplebus/SimpleBus.scala:76:27, :91:24, src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :422:{57,79}, :425:23, :426:75, :430:{30,54}, :433:23, :436:23
  ...
  wire        io_isFinish_0 =
    probe
      ...
      : hit | io_in_bits_req_cmd[0]
          ? io_out_valid_0
          : _io_isFinish_T_9 & (io_out_valid_0 | alreadyOutFire);	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/nutcore/mem/Cache.scala:260:25, :261:26, :262:39, :294:22, :306:66, :337:33, :343:{31,53}, :445:31, :446:48, :454:{21,45,51,98}, :455:{8,13,68,84}
  wire        io_in_ready_0 = ~(|state) & ~hitReadBurst & ~miss & ~probe;	// src/main/scala/nutcore/mem/Cache.scala:261:26, :262:39, :263:26, :294:22, :343:31, :458:{55,73,79,82}
  ...
  `ifndef SYNTHESIS	// src/main/scala/nutcore/mem/Cache.scala:265:9
    always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:265:9
      automatic logic [255:0] _GEN_4;	// src/main/scala/nutcore/mem/Cache.scala:464:465
      ...
      if (_GEN_5) begin	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                " metaread idx %x waymask %b metas %x%x:%x %x%x:%x %x%x:%x %x%x:%x %x\n",
                io_in_bits_req_addr[14:6], io_in_bits_waymask, io_in_bits_metas_0_valid,
                ...
                io_in_bits_metas_3_tag, _GEN_4);	// src/main/scala/nutcore/mem/Cache.scala:77:45, :464:465, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _metaWriteArb_io_out_valid & _LogPerfHelper_logEnable
        ...
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "%d: [l2cache S3]: metawrite idx %x wmask %b meta %x%x:%x\n", c,
                _metaWriteArb_io_out_bits_setIdx, _metaWriteArb_io_out_bits_waymask, 1'h1,
                _metaWriteArb_io_out_bits_data_dirty, _metaWriteArb_io_out_bits_data_tag);	// src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :284:29, :288:29, :366:38, :463:9, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/GTimer.scala:24:20
      end
      if (_GEN_5) begin	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                ...
                io_in_bits_req_cmd, probe, io_isFinish_0);	// src/main/scala/nutcore/mem/Cache.scala:260:25, :262:39, :294:22, :454:21, :458:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, " out.valid:%d rdata:%x cmd:%d user:%x id:%x \n",
                io_out_valid_0, io_out_bits_rdata_0, io_out_bits_cmd_0, 1'h0, 1'h0);	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :422:79, :424:25, :425:23, :426:75, :445:31, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, " DHW: (%d, %d), data:%x setIdx:%x MHW:(%d, %d)\n",
                hitWrite, 1'h1, dataHitWriteBus_x1_data, dataHitWriteBus_x3,
                metaHitWriteBus_x5, 1'h1);	// src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :283:22, :284:29, :286:35, :288:29, :289:22, :366:38, :463:9, src/main/scala/utils/BitUtils.scala:34:26, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, " DreadCache: %x \n", _GEN_4);	// src/main/scala/nutcore/mem/Cache.scala:464:465, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
      ...
      if ((`PRINTF_COND_) & _io_mem_req_valid_T_1 & _GEN_0 & _LogPerfHelper_logEnable
        ...
        $fwrite(32'h80000002,
                ...
                io_mem_req_bits_cmd_0, 3'h3, 8'hFF, io_in_bits_req_addr[31:15],
                io_in_bits_req_addr[14:6], io_in_bits_waymask);	// src/main/scala/bus/simplebus/SimpleBus.scala:65:14, src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/Cache.scala:77:45, :258:31, :323:8, :324:35, src/main/scala/utils/BitUtils.scala:27:45, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _io_mem_req_valid_T & _GEN_0 & _LogPerfHelper_logEnable
        ...
        $fwrite(32'h80000002, "[COUTR] addr %x tag %x idx %x waymask %b \n",
                io_mem_req_bits_addr_0, io_in_bits_req_addr[31:15],
                io_in_bits_req_addr[14:6], io_in_bits_waymask);	// src/main/scala/nutcore/mem/Cache.scala:77:45, :258:31, :324:35, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _GEN_1 & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:265:9, :422:37, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_2: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[COUTR] cnt %x data %x tag %x idx %x waymask %b \n",
                readBeatCnt_value, io_mem_resp_bits_rdata, io_in_bits_req_addr[31:15],
                io_in_bits_req_addr[14:6], io_in_bits_waymask);	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/nutcore/mem/Cache.scala:77:45, :258:31, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
    if (reset) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
      ...
      c <= 64'h0;	// src/main/scala/nutcore/mem/Cache.scala:252:14, src/main/scala/utils/GTimer.scala:24:20
    end
      ...
      automatic logic _GEN_11;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
      automatic logic _GEN_12;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18
      automatic logic _GEN_13;	// src/main/scala/nutcore/mem/Cache.scala:353:18
      _GEN_6 = state == 4'h5;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_7 = state == 4'h6;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_8 = state == 4'h8;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_9 = state == 4'h1;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_10 = state == 4'h2;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_11 = _GEN_10 & io_mem_resp_valid;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
      _GEN_12 = _GEN_6 | _GEN_7 | _GEN_8 | _GEN_9;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18
      _GEN_13 = state == 4'h3;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      if (~(|state) | _GEN_12
          | ~(_GEN_10 & io_mem_resp_valid & _dataHitWriteBus_x3_T)) begin	// src/main/scala/nutcore/mem/Cache.scala:279:{32,83}, :294:22, :336:31, :343:31, :353:18, :385:31, :388:{52,75}
      ...
      if (|state) begin	// src/main/scala/nutcore/mem/Cache.scala:294:22, :343:31
        if (~(_GEN_6 | _GEN_7)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/nutcore/mem/Cache.scala:353:18
          if (_GEN_8) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
            ...
            if (_GEN_10) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
            ...
            else if (_GEN_13) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
              ...
              state <= 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22
            if (_GEN_11)	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
              readBeatCnt_value <= readBeatCnt_value + 3'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24, src/main/scala/nutcore/mem/Cache.scala:322:23
          end
        end
      end
        ...
        state <= mmio ? 4'h5 : {2'h0, _meta_T_10, 1'h1};	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :259:26, :284:29, :288:29, :294:22, :304:23, :366:38, :367:{21,42}, :463:9
      if (~(|state) | _GEN_6 | _GEN_7 | _GEN_8 | _GEN_9 | _GEN_10
          | ~(_GEN_13 & _GEN_0)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:15, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:294:22, :343:31, :353:18, :394:30
      end
      ...
      else if (state2 == 2'h2 & (_GEN_0 | io_cohResp_valid | hitReadBurst))	// src/main/scala/bus/simplebus/SimpleBus.scala:76:27, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:263:26, :304:23, :311:19, :314:{63,96,105}, :343:53
        state2 <= 2'h0;	// src/main/scala/nutcore/mem/Cache.scala:304:23
      afterFirstRead <= (|state) & (~_GEN_12 & _GEN_11 | afterFirstRead);	// src/main/scala/nutcore/mem/Cache.scala:294:22, :336:31, :343:31, :353:18, :355:22, :385:31, :386:24
  ...
  Arbiter2_SRAMBundleAW_5 dataWriteArb (	// src/main/scala/nutcore/mem/Cache.scala:255:28
    ...
    .io_in_0_bits_data_data (dataHitWriteBus_x1_data),	// src/main/scala/utils/BitUtils.scala:34:26
    .io_in_0_bits_waymask   (io_in_bits_waymask),
  ...
  assign io_in_ready = io_in_ready_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :458:79
  assign io_out_valid = io_out_valid_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :445:31
  assign io_out_bits_cmd = io_out_bits_cmd_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :422:79, :425:23, :426:75
  assign io_out_bits_rdata = io_out_bits_rdata_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :422:79, :424:25, :426:75
  assign io_isFinish = io_isFinish_0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :454:21
