...
module Cache(	// src/main/scala/nutcore/mem/Cache.scala:478:7
  ...
  wire        _arb_io_in_0_ready;	// src/main/scala/nutcore/mem/Cache.scala:493:19
  ...
  wire        _s2_io_out_bits_metas_0_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18
  ...
  wire        _s2_io_out_bits_metas_1_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18
  ...
  wire        _s2_io_out_bits_metas_2_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18
  ...
  wire        _s2_io_out_bits_metas_3_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18
  ...
  reg         s3_io_in_bits_rmetas_0_valid;	// src/main/scala/utils/Pipeline.scala:30:28
  ...
  reg         s3_io_in_bits_rmetas_1_valid;	// src/main/scala/utils/Pipeline.scala:30:28
  ...
  reg         s3_io_in_bits_rmetas_2_valid;	// src/main/scala/utils/Pipeline.scala:30:28
  ...
  reg         s3_io_in_bits_rmetas_3_valid;	// src/main/scala/utils/Pipeline.scala:30:28
  ...
  wire        io_in_resp_valid_0 =
    ...
    & (_s3_io_out_valid | _s3_io_dataReadRespToL1);	// src/main/scala/bus/simplebus/SimpleBus.scala:95:24, src/main/scala/nutcore/mem/Cache.scala:482:18, :510:{26,43,98}
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Cache: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "InReq(%d, %d) InResp(%d, %d) \n", io_in_req_valid,
                _arb_io_in_0_ready, io_in_resp_valid_0, io_in_resp_ready);	// src/main/scala/nutcore/mem/Cache.scala:493:19, :510:26, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Cache: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "{IN s1:(%d,%d), s2:(%d,%d), s3:(%d,%d)} {OUT s1:(%d,%d), s2:(%d,%d), s3:(%d,%d)}\n",
                _arb_io_out_valid, _s1_io_in_ready, valid, _s2_io_in_ready, valid_1,
                _s3_io_in_ready, _s1_io_out_valid, _s2_io_in_ready, _s2_io_out_valid,
                _s3_io_in_ready, _s3_io_out_valid, io_in_resp_ready);	// src/main/scala/nutcore/mem/Cache.scala:480:18, :481:18, :482:18, :493:19, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:24:24
      end
      if ((`PRINTF_COND_) & _arb_io_out_valid & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:493:19, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Cache: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "[icache.S1]: addr = 0x%x, cmd = %d, size = %d, wmask = 0x%x, wdata = 0x%x\n",
                _arb_io_out_bits_addr, 4'h0, 3'h3, 8'h0, 64'h0);	// src/main/scala/nutcore/mem/Cache.scala:122:14, :480:18, :493:19, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & valid & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:24:24
        $fwrite(32'h80000002, "[%d] Cache: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "[icache.S2]: addr = 0x%x, cmd = %d, size = %d, wmask = 0x%x, wdata = 0x%x\n",
                s2_io_in_bits_rreq_addr, s2_io_in_bits_rreq_cmd,
                s2_io_in_bits_rreq_size, s2_io_in_bits_rreq_wmask,
                s2_io_in_bits_rreq_wdata);	// src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:30:28
      end
      if ((`PRINTF_COND_) & valid_1 & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:24:24
        $fwrite(32'h80000002, "[%d] Cache: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "[icache.S3]: addr = 0x%x, cmd = %d, size = %d, wmask = 0x%x, wdata = 0x%x\n",
                s3_io_in_bits_rreq_addr, s3_io_in_bits_rreq_cmd,
                s3_io_in_bits_rreq_size, s3_io_in_bits_rreq_wmask,
                s3_io_in_bits_rreq_wdata);	// src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:30:28
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:478:7
    ...
    if (_s2_io_in_bits_T) begin	// src/main/scala/utils/Pipeline.scala:26:22
      ...
      s2_io_in_bits_rreq_size <= 3'h3;	// src/main/scala/nutcore/mem/Cache.scala:122:14, :480:18, :493:19, src/main/scala/utils/Pipeline.scala:30:28
      s2_io_in_bits_rreq_cmd <= 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:122:14, :480:18, :493:19, src/main/scala/utils/Pipeline.scala:30:28
      s2_io_in_bits_rreq_wmask <= 8'h0;	// src/main/scala/nutcore/mem/Cache.scala:122:14, :480:18, :493:19, src/main/scala/utils/Pipeline.scala:30:28
      s2_io_in_bits_rreq_wdata <= 64'h0;	// src/main/scala/nutcore/mem/Cache.scala:122:14, :480:18, :493:19, src/main/scala/utils/Pipeline.scala:30:28
    ...
    if (_s3_io_in_bits_T) begin	// src/main/scala/utils/Pipeline.scala:26:22
      ...
      s3_io_in_bits_rmetas_0_valid <= _s2_io_out_bits_metas_0_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18, src/main/scala/utils/Pipeline.scala:30:28
      ...
      s3_io_in_bits_rmetas_1_valid <= _s2_io_out_bits_metas_1_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18, src/main/scala/utils/Pipeline.scala:30:28
      ...
      s3_io_in_bits_rmetas_2_valid <= _s2_io_out_bits_metas_2_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18, src/main/scala/utils/Pipeline.scala:30:28
      ...
      s3_io_in_bits_rmetas_3_valid <= _s2_io_out_bits_metas_3_valid;	// src/main/scala/nutcore/mem/Cache.scala:481:18, src/main/scala/utils/Pipeline.scala:30:28
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/nutcore/mem/Cache.scala:478:7
    ...
    initial begin	// src/main/scala/nutcore/mem/Cache.scala:478:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/nutcore/mem/Cache.scala:478:7
        ...
        s3_io_in_bits_rmetas_0_valid = _RANDOM[5'hD][1];	// src/main/scala/nutcore/mem/Cache.scala:478:7, src/main/scala/utils/Pipeline.scala:30:28
        ...
        s3_io_in_bits_rmetas_1_valid = _RANDOM[5'hD][22];	// src/main/scala/nutcore/mem/Cache.scala:478:7, src/main/scala/utils/Pipeline.scala:30:28
        ...
        s3_io_in_bits_rmetas_2_valid = _RANDOM[5'hE][11];	// src/main/scala/nutcore/mem/Cache.scala:478:7, src/main/scala/utils/Pipeline.scala:30:28
        ...
        s3_io_in_bits_rmetas_3_valid = _RANDOM[5'hF][0];	// src/main/scala/nutcore/mem/Cache.scala:478:7, src/main/scala/utils/Pipeline.scala:30:28
  ...
  CacheStage3 s3 (	// src/main/scala/nutcore/mem/Cache.scala:482:18
    ...
    .io_in_bits_metas_0_valid            (s3_io_in_bits_rmetas_0_valid),	// src/main/scala/utils/Pipeline.scala:30:28
    ...
    .io_in_bits_metas_1_valid            (s3_io_in_bits_rmetas_1_valid),	// src/main/scala/utils/Pipeline.scala:30:28
    ...
    .io_in_bits_metas_2_valid            (s3_io_in_bits_rmetas_2_valid),	// src/main/scala/utils/Pipeline.scala:30:28
    ...
    .io_in_bits_metas_3_valid            (s3_io_in_bits_rmetas_3_valid),	// src/main/scala/utils/Pipeline.scala:30:28
  ...
  assign io_in_req_ready = _arb_io_in_0_ready;	// src/main/scala/nutcore/mem/Cache.scala:478:7, :493:19
  assign io_in_resp_valid = io_in_resp_valid_0;	// src/main/scala/nutcore/mem/Cache.scala:478:7, :510:26
