...
module CacheStage1(	// src/main/scala/nutcore/mem/Cache.scala:126:14
  ...
  `ifndef SYNTHESIS	// src/main/scala/nutcore/mem/Cache.scala:135:37
    always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:135:37
      if ((`PRINTF_COND_) & io_in_ready_0 & io_in_valid & _LogPerfHelper_logEnable
          & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:135:37, :145:76, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[L1$] cache stage1, addr in: %x, user: %x id: %x\n",
                io_in_bits_addr, io_in_bits_user, 1'h0);	// src/main/scala/nutcore/mem/Cache.scala:135:38, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:135:37, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                ...
                4'h0, readBusValid);	// src/main/scala/nutcore/mem/Cache.scala:133:14, :139:34, :144:59, :145:76, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
