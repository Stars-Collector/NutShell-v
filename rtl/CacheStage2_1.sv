  ...
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      ...
      if ((`PRINTF_COND_) & (|(_GEN_0[2:1])) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:201:{16,26}, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaWay %x metat %x reqt %x\n", metaWay_0_valid,
                metaWay_0_tag, io_in_bits_req_addr[31:13]);	// src/main/scala/nutcore/mem/Cache.scala:174:31, :187:22, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaWay %x metat %x reqt %x\n", metaWay_1_valid,
                metaWay_1_tag, io_in_bits_req_addr[31:13]);	// src/main/scala/nutcore/mem/Cache.scala:174:31, :187:22, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaWay %x metat %x reqt %x\n", metaWay_2_valid,
                metaWay_2_tag, io_in_bits_req_addr[31:13]);	// src/main/scala/nutcore/mem/Cache.scala:174:31, :187:22, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaWay %x metat %x reqt %x\n", metaWay_3_valid,
                metaWay_3_tag, io_in_bits_req_addr[31:13]);	// src/main/scala/nutcore/mem/Cache.scala:174:31, :187:22, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaReadResp %x metat %x reqt %x\n",
                io_metaReadResp_0_valid, io_metaReadResp_0_tag,
                io_in_bits_req_addr[31:13]);	// src/main/scala/nutcore/mem/Cache.scala:174:31, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[ERROR] metaReadResp %x metat %x reqt %x\n",
      ...
      if ((`PRINTF_COND_) & (|(_GEN_0[2:1])) & _LogPerfHelper_1_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/mem/Cache.scala:201:{16,26}, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_1_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
      ...
      if ((`PRINTF_COND_) & _LogPerfHelper_2_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage2_1: ", _LogPerfHelper_2_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        ...
        $fwrite(32'h80000002, "[isFM:%d isFMreg:%d metawreq:%x widx:%x ridx:%x \n",
                ...
                io_metaWriteBus_req_bits_setIdx, io_in_bits_req_addr[12:6]);	// src/main/scala/nutcore/mem/Cache.scala:77:45, :176:64, :177:33, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
