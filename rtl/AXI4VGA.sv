...
module AXI4VGA(	// src/main/scala/device/AXI4VGA.scala:115:7
  ...
  input         io_in_fb_arvalid,	// src/main/scala/device/AXI4VGA.scala:117:14
                io_in_fb_rready,	// src/main/scala/device/AXI4VGA.scala:117:14
  output        io_in_fb_rvalid,	// src/main/scala/device/AXI4VGA.scala:117:14
                io_in_ctrl_awready,	// src/main/scala/device/AXI4VGA.scala:117:14
  ...
  input         io_in_ctrl_wvalid,	// src/main/scala/device/AXI4VGA.scala:117:14
                io_in_ctrl_bready,	// src/main/scala/device/AXI4VGA.scala:117:14
  output        io_in_ctrl_bvalid,	// src/main/scala/device/AXI4VGA.scala:117:14
                io_in_ctrl_arready,	// src/main/scala/device/AXI4VGA.scala:117:14
  ...
  wire [63:0] data = _fb_io_in_rvalid ? _fb_io_in_rdata : data_r;	// src/main/scala/device/AXI4VGA.scala:127:18, src/main/scala/utils/Hold.scala:23:{48,65}
  always @(posedge clock) begin	// src/main/scala/device/AXI4VGA.scala:115:7
    ...
    if (reset) begin	// src/main/scala/device/AXI4VGA.scala:115:7
      ...
      vga_fb_used <=
        io_in_fb_awvalid | io_in_fb_wvalid | io_in_fb_arvalid | vga_fb_used;	// src/main/scala/device/AXI4VGA.scala:138:28, :140:63, :141:17
      if (hCounter == 11'h41F) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24
        ...
        if (vCounter == 10'h273)	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24
          ...
          vCounter <= vCounter + 10'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
      end
      else	// src/main/scala/chisel3/util/Counter.scala:73:24
  ...
  FBHelper fbHelper (	// src/main/scala/device/AXI4VGA.scala:177:26
    .clk   (clock),
    .valid (hCounter > 11'hA7 & hCounter < 11'h3C8 & vInRange & vga_fb_used),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/device/AXI4VGA.scala:138:28, :144:{51,63,69}, :179:39
