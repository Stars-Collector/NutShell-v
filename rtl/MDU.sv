...
module MDU(	// src/main/scala/nutcore/backend/fu/MDU.scala:135:7
  ...
  wire         io_out_valid_0 =
    (io_in_ready & io_in_valid ? io_in_bits_func[2] : isDivReg_REG)
      ? _div_io_out_valid
      : _mul_io_out_valid;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/backend/fu/MDU.scala:41:27, :151:19, :152:19, :181:{21,48}, :182:21, :183:22
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] MDU: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[FU-MDU] irv-orv %d %d - %d %d\n", io_in_ready,
                io_in_valid, 1'h1, io_out_valid_0);	// src/main/scala/nutcore/backend/fu/MDU.scala:135:7, :182:21, :183:22, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  assign io_out_valid = io_out_valid_0;	// src/main/scala/nutcore/backend/fu/MDU.scala:135:7, :183:22
