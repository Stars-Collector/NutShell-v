...
module Decoder(	// src/main/scala/nutcore/frontend/IDU.scala:26:7
  input         clock,	// src/main/scala/nutcore/frontend/IDU.scala:26:7
                reset,	// src/main/scala/nutcore/frontend/IDU.scala:26:7
  ...
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & _io_in_ready_T_1 & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Decoder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "issue: pc %x npc %x instr %x\n", io_in_bits_pc,
                io_in_bits_pnpc, io_in_bits_instr);	// src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  assign io_in_ready = ~io_in_valid | _io_in_ready_T_1 & ~(|intrVec__bore);	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/frontend/IDU.scala:26:7, :162:{18,31,46,49}, :172:22
