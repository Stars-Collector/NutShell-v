...
module CacheStage3_1(	// src/main/scala/nutcore/mem/Cache.scala:235:14
  ...
  wire        _GEN_1 = io_mem_req_ready & io_mem_req_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:329:48
  ...
  wire [3:0]  io_mem_req_bits_cmd_0 = {1'h0, cmd};	// src/main/scala/bus/simplebus/SimpleBus.scala:65:14, src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :322:16
  ...
  wire [3:0]  io_out_bits_cmd_0 =
    {1'h0,
     io_in_bits_req_cmd[0] | io_in_bits_req_cmd[3]
       ...
       : 3'h6};	// src/main/scala/bus/simplebus/SimpleBus.scala:73:33, :74:22, src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :347:54, :440:{21,27,79}
  ...
  wire        io_isFinish_0 =
    probe
      ...
      : hit | io_in_bits_req_cmd[0]
          ? _io_isFinish_T_10
          : _io_isFinish_T_9 & (_io_isFinish_T_10 | alreadyOutFire);	// src/main/scala/bus/simplebus/SimpleBus.scala:74:22, src/main/scala/chisel3/util/Counter.scala:117:24, :118:{16,23}, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:260:25, :261:26, :262:39, :294:22, :306:66, :337:33, :343:{31,53}, :446:48, :454:{21,45,51,98}, :455:{8,13,68,84}
  wire        io_in_ready_0 = io_out_ready & ~(|state) & ~hitReadBurst & ~miss & ~probe;	// src/main/scala/nutcore/mem/Cache.scala:261:26, :262:39, :263:26, :294:22, :343:31, :458:{55,73,79,82}
  ...
  `ifndef SYNTHESIS	// src/main/scala/nutcore/mem/Cache.scala:265:9
    always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:265:9
      automatic logic [255:0] _GEN_2;	// src/main/scala/nutcore/mem/Cache.scala:464:465
      ...
      if (_GEN_3) begin	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                ...
                io_in_bits_metas_3_tag, _GEN_2);	// src/main/scala/nutcore/mem/Cache.scala:77:45, :464:465, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _metaWriteArb_io_out_valid & _LogPerfHelper_logEnable
        ...
        $fwrite(32'h80000002, "%d: [dcache S3]: metawrite idx %x wmask %b meta %x%x:%x\n",
                ...
                _metaWriteArb_io_out_bits_data_tag);	// src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :284:29, :288:29, :366:38, :463:9, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/GTimer.scala:24:20
      end
      if (_GEN_3) begin	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
        ...
        $fwrite(32'h80000002, " out.valid:%d rdata:%x cmd:%d user:%x id:%x \n",
                io_out_valid_0, io_out_bits_rdata_0, io_out_bits_cmd_0, 1'h0, 1'h0);	// src/main/scala/nutcore/mem/Cache.scala:252:14, :297:18, :439:29, :440:21, :445:31, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        ...
        $fwrite(32'h80000002, "[%d] CacheStage3_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, " DreadCache: %x \n", _GEN_2);	// src/main/scala/nutcore/mem/Cache.scala:464:465, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] CacheStage3_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
      ...
      if ((`PRINTF_COND_) & _io_mem_req_valid_T_1 & _GEN_1 & _LogPerfHelper_logEnable
      ...
      if ((`PRINTF_COND_) & _io_mem_req_valid_T & _GEN_1 & _LogPerfHelper_logEnable
  ...
  always @(posedge clock) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
    if (reset) begin	// src/main/scala/nutcore/mem/Cache.scala:235:14
      ...
      automatic logic _GEN_9;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
      automatic logic _GEN_10;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18
      automatic logic _GEN_11;	// src/main/scala/nutcore/mem/Cache.scala:353:18
      ...
      _GEN_4 = state == 4'h5;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_5 = state == 4'h6;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_6 = state == 4'h8;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_7 = state == 4'h1;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_8 = state == 4'h2;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      _GEN_9 = _GEN_8 & io_mem_resp_valid;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
      _GEN_10 = _GEN_4 | _GEN_5 | _GEN_6 | _GEN_7;	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18
      _GEN_11 = state == 4'h3;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22, :353:18
      if (~(|state) | _GEN_10
          | ~(_GEN_8 & io_mem_resp_valid & _dataHitWriteBus_x3_T)) begin	// src/main/scala/nutcore/mem/Cache.scala:279:{32,83}, :294:22, :336:31, :343:31, :353:18, :385:31, :388:{52,75}
      ...
      if (|state) begin	// src/main/scala/nutcore/mem/Cache.scala:294:22, :343:31
        ...
        if (_GEN_4) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
        ...
        else if (_GEN_11) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
          ...
          state <= 4'h0;	// src/main/scala/nutcore/mem/Cache.scala:235:14, :294:22
        if (~(_GEN_4 | _GEN_5)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/nutcore/mem/Cache.scala:353:18
          if (_GEN_6) begin	// src/main/scala/nutcore/mem/Cache.scala:353:18
          ...
          else if (_GEN_9)	// src/main/scala/nutcore/mem/Cache.scala:336:31, :353:18, :385:31, :386:24
            readBeatCnt_value <= readBeatCnt_value + 3'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24, src/main/scala/nutcore/mem/Cache.scala:322:23
        end
      end
        ...
        state <= _GEN ? 4'h5 : {2'h0, _meta_T_10, 1'h1};	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :270:35, :284:29, :288:29, :294:22, :304:23, :366:38, :367:{21,42}, :463:9
      if (~(|state) | _GEN_4 | _GEN_5 | _GEN_6 | _GEN_7 | _GEN_8
          | ~(_GEN_11 & _GEN_1)) begin	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:15, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/mem/Cache.scala:294:22, :343:31, :353:18, :394:30
      end
      ...
      if (_GEN_0) begin	// src/main/scala/nutcore/mem/Cache.scala:306:92
        ...
        state2 <= 2'h0;	// src/main/scala/nutcore/mem/Cache.scala:304:23
      afterFirstRead <= (|state) & (~_GEN_10 & _GEN_9 | afterFirstRead);	// src/main/scala/nutcore/mem/Cache.scala:294:22, :336:31, :343:31, :353:18, :355:22, :385:31, :386:24
  ...
  Arbiter2_SRAMBundleAW metaWriteArb (	// src/main/scala/nutcore/mem/Cache.scala:254:28
    ...
    .io_in_0_bits_data_dirty (1'h1),	// src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :284:29, :288:29, :366:38, :463:9
  ...
  assign io_cohResp_bits_cmd =
    _io_dataReadRespToL1_T_2 ? {1'h0, releaseLast ? 3'h6 : 3'h0} : {1'h1, hit, 2'h0};	// src/main/scala/chisel3/util/Counter.scala:61:40, :117:24, :118:{16,23}, src/main/scala/nutcore/mem/Cache.scala:235:14, :252:14, :254:28, :255:28, :260:25, :284:29, :288:29, :297:18, :304:23, :306:66, :347:{29,54}, :348:8, :366:38, :463:9
