...
module SimpleBusCrossbar1toN(	// src/main/scala/bus/simplebus/Crossbar.scala:25:7
  ...
  wire [2:0]  outSelVec_enc =
    io_in_req_bits_addr > 32'h37FFFFFF & io_in_req_bits_addr < 32'h38010000
      ...
      : io_in_req_bits_addr > 32'h3BFFFFFF & io_in_req_bits_addr < 32'h40000000
          ? 3'h2
          : {(|(io_in_req_bits_addr[31:30])) & ~(io_in_req_bits_addr[31]), 2'h0};	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, :32:22, :37:{20,34,42}, src/main/scala/chisel3/util/Mux.scala:50:70
  ...
  wire        reqInvalidAddr = io_in_req_valid & outSelVec_enc == 3'h0;	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, :42:{40,61}, src/main/scala/chisel3/util/Mux.scala:50:70
  ...
  wire [63:0] _io_in_resp_bits_T_4 =
    (outSelRespVec_0 ? io_out_0_resp_bits_rdata : 64'h0)
    | (outSelRespVec_1 ? io_out_1_resp_bits_rdata : 64'h0)
    | (outSelRespVec_2 ? io_out_2_resp_bits_rdata : 64'h0);	// src/main/scala/bus/simplebus/Crossbar.scala:39:32, src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/utils/GTimer.scala:24:20
  wire [3:0]  _io_in_resp_bits_T_9 =
    (outSelRespVec_0 | outSelRespVec_1 ? 4'h6 : 4'h0)
    | (outSelRespVec_2 ? io_out_2_resp_bits_cmd : 4'h0);	// src/main/scala/bus/simplebus/Crossbar.scala:26:14, :39:32, src/main/scala/chisel3/util/Mux.scala:30:73
  ...
  `ifndef SYNTHESIS	// src/main/scala/bus/simplebus/Crossbar.scala:46:13
    always @(posedge clock) begin	// src/main/scala/bus/simplebus/Crossbar.scala:46:13
      ...
      if ((`PRINTF_COND_) & _LogPerfHelper_1_logEnable & io_in_resp_valid_0 & ~reset)	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/bus/simplebus/Crossbar.scala:46:13, :71:70, :80:13
        $fwrite(32'h80000002,
                "%d: xbar: outSelVec = Vec(%d, %d, %d), outSel.resp: rdata = %x, cmd = %d\n",
                c_2, outSelVec_enc[0], outSelVec_enc[1], outSelVec_enc[2],
                _io_in_resp_bits_T_4, _io_in_resp_bits_T_9);	// src/main/scala/bus/simplebus/Crossbar.scala:46:13, :80:13, src/main/scala/chisel3/util/Mux.scala:30:73, :50:70, src/main/scala/chisel3/util/OneHot.scala:83:30, src/main/scala/utils/GTimer.scala:24:20
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/bus/simplebus/Crossbar.scala:25:7
    ...
    initial begin	// src/main/scala/bus/simplebus/Crossbar.scala:25:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/bus/simplebus/Crossbar.scala:25:7
        ...
        c = {_RANDOM[3'h0][31:5], _RANDOM[3'h1], _RANDOM[3'h2][4:0]};	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, :32:22, src/main/scala/utils/GTimer.scala:24:20
        c_1 = {_RANDOM[3'h2][31:5], _RANDOM[3'h3], _RANDOM[3'h4][4:0]};	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, src/main/scala/utils/GTimer.scala:24:20
        c_2 = {_RANDOM[3'h4][31:5], _RANDOM[3'h5], _RANDOM[3'h6][4:0]};	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, src/main/scala/utils/GTimer.scala:24:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_in_resp_bits_cmd = _io_in_resp_bits_T_9;	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, src/main/scala/chisel3/util/Mux.scala:30:73
  assign io_in_resp_bits_rdata = _io_in_resp_bits_T_4;	// src/main/scala/bus/simplebus/Crossbar.scala:25:7, src/main/scala/chisel3/util/Mux.scala:30:73
