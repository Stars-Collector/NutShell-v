...
module IFU_inorder(	// src/main/scala/nutcore/frontend/IFU.scala:309:7
  ...
  wire        io_out_valid_0;	// src/main/scala/nutcore/frontend/IFU.scala:391:38
  wire [38:0] io_out_bits_pc_0;	// src/main/scala/nutcore/frontend/IFU.scala:386:24
  ...
  wire        pcUpdate = io_redirect_valid | _bp1_io_in_pc_valid_T;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/frontend/IFU.scala:323:36
  ...
  wire [38:0] snpc = pc[1] ? _snpc_T_1 : _snpc_T_3;	// src/main/scala/nutcore/frontend/IFU.scala:322:19, :324:{17,20,28,38}
  ...
  wire [38:0] npc =
    io_redirect_valid
      ? io_redirect_target
      : crosslineJumpLatch ? crosslineJumpTarget : _GEN_0 ? snpc : _bp1_io_out_target;	// src/main/scala/nutcore/frontend/IFU.scala:324:17, :326:19, :329:35, :333:38, :340:{16,59,104}
  wire        npcIsSeq =
    ~(io_redirect_valid | crosslineJumpLatch)
    & (_bp1_io_crosslineJump | ~_bp1_io_out_valid);	// src/main/scala/nutcore/frontend/IFU.scala:326:19, :329:35, :341:{21,54,87,114}
  wire [2:0]  _brIdx_T = io_redirect_valid ? 3'h0 : _bp1_io_brIdx;	// src/main/scala/nutcore/frontend/IFU.scala:326:19, :349:29
  wire [38:0] x1 = {pc[38:1], 1'h0};	// src/main/scala/nutcore/frontend/IFU.scala:322:19, :329:35, :370:{36,39}
  wire [81:0] x6 = {npcIsSeq, _brIdx_T, npc, pc};	// src/main/scala/nutcore/frontend/IFU.scala:322:19, :340:16, :341:{21,54}, :349:29, :371:82
  ...
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & pcUpdate & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/frontend/IFU.scala:323:36, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] IFU_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "[IFUPC] pc:%x pcUpdate:%d npc:%x RedValid:%d RedTarget:%x LJL:%d LJTarget:%x LJ:%d snpc:%x bpValid:%d pnpn:%x \n",
                pc, pcUpdate, npc, io_redirect_valid, io_redirect_target,
                crosslineJumpLatch, crosslineJumpTarget, _bp1_io_crosslineJump, snpc,
                _bp1_io_out_valid, _bp1_io_crosslineJump ? snpc : _bp1_io_out_target);	// src/main/scala/nutcore/frontend/IFU.scala:322:19, :323:36, :324:17, :326:19, :329:35, :333:38, :338:17, :340:16, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & _bp1_io_in_pc_valid_T & _LogPerfHelper_logEnable
          & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] IFU_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[IFI] pc=%x user=%x %x %x %x \n", x1, x6,
                io_redirect_valid, _bp1_io_brIdx, {npcIsSeq, _brIdx_T});	// src/main/scala/nutcore/frontend/IFU.scala:326:19, :341:{21,54}, :349:{15,29}, :370:36, :371:82, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & io_out_ready & io_out_valid_0 & _LogPerfHelper_logEnable
          & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/frontend/IFU.scala:391:38, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] IFU_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "[IFO] pc=%x inst=%x\n", io_out_bits_pc_0,
                io_imem_resp_bits_rdata);	// src/main/scala/nutcore/frontend/IFU.scala:386:24, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  assign io_out_bits_pc_0 = io_imem_resp_bits_user[38:0];	// src/main/scala/nutcore/frontend/IFU.scala:386:24
  assign io_out_valid_0 = io_imem_resp_valid & ~io_redirect_valid;	// src/main/scala/nutcore/frontend/IFU.scala:391:{38,41}
  ...
  assign io_imem_req_bits_addr = x1;	// src/main/scala/nutcore/frontend/IFU.scala:309:7, :370:36
  assign io_imem_req_bits_user = x6;	// src/main/scala/nutcore/frontend/IFU.scala:309:7, :371:82
  assign io_imem_resp_ready = io_imem_resp_ready_0;	// src/main/scala/nutcore/frontend/IFU.scala:309:7, :374:38
  assign io_out_valid = io_out_valid_0;	// src/main/scala/nutcore/frontend/IFU.scala:309:7, :391:38
  assign io_out_bits_instr = io_imem_resp_bits_rdata;	// src/main/scala/nutcore/frontend/IFU.scala:309:7
  assign io_out_bits_pc = io_out_bits_pc_0;	// src/main/scala/nutcore/frontend/IFU.scala:309:7, :386:24
