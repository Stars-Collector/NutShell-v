...
module EmbeddedTLB_1(	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:79:7
  ...
  wire         io_in_req_ready_0 = _GEN ? _tlbExec_io_in_ready : io_out_req_ready;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:85:23, :115:16, :128:19, :132:21, :152:35
  wire [31:0]  io_out_req_bits_addr_0 =
    _GEN ? _tlbEmpty_io_out_bits_addr : io_in_req_bits_addr[31:0];	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:86:24, :128:19, :133:{26,48}, :140:41, :152:35
  wire [3:0]   io_out_req_bits_cmd_0 =
    _GEN ? _tlbEmpty_io_out_bits_cmd : io_in_req_bits_cmd;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:86:24, :128:19, :135:25, :140:41, :152:35
  wire [63:0]  io_out_req_bits_wdata_0 =
    _GEN ? _tlbEmpty_io_out_bits_wdata : io_in_req_bits_wdata;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:86:24, :128:19, :137:27, :140:41, :152:35
  wire         io_out_req_valid_0 = _GEN ? _tlbEmpty_io_out_valid : io_in_req_valid;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:86:24, :128:19, :131:22, :140:41, :152:35
  ...
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] EmbeddedTLB_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "InReq(%d, %d) InResp(%d, %d) OutReq(%d, %d) OutResp(%d, %d) vmEnable:%d mode:%d\n",
                io_in_req_valid, io_in_req_ready_0, io_out_resp_valid, 1'h1,
                io_out_req_valid_0, io_out_req_ready, io_out_resp_valid, 1'h1, _GEN,
                io_csrMMU_privilegeMode);	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:37:14, :79:7, :85:23, :115:16, :128:19, :131:22, :132:21, :140:41, :152:35, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] EmbeddedTLB_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "InReq: addr:%x cmd:%d wdata:%x OutReq: addr:%x cmd:%x wdata:%x\n",
                io_in_req_bits_addr, io_in_req_bits_cmd, io_in_req_bits_wdata,
                io_out_req_bits_addr_0, io_out_req_bits_cmd_0, io_out_req_bits_wdata_0);	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:128:19, :133:26, :135:25, :137:27, :140:41, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] EmbeddedTLB_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "OutResp: rdata:%x cmd:%x Inresp: rdata:%x cmd:%x\n",
                io_out_resp_bits_rdata, io_out_resp_bits_cmd, io_out_resp_bits_rdata,
                io_out_resp_bits_cmd);	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] EmbeddedTLB_1: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "satp:%x flush:%d cacheEmpty:%d instrPF:%d loadPF:%d storePF:%d \n",
                satp__bore, 1'h0, io_cacheEmpty, 1'h0, _tlbExec_io_pf_loadPF,
                _tlbExec_io_pf_storePF);	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:37:14, :85:23, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  assign io_out_req_valid = io_out_req_valid_0;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:79:7, :128:19, :131:22, :140:41
  assign io_out_req_bits_addr = io_out_req_bits_addr_0;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:79:7, :128:19, :133:26, :140:41
  ...
  assign io_out_req_bits_cmd = io_out_req_bits_cmd_0;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:79:7, :128:19, :135:25, :140:41
  ...
  assign io_out_req_bits_wdata = io_out_req_bits_wdata_0;	// src/main/scala/nutcore/mem/EmbeddedTLB.scala:79:7, :128:19, :137:27, :140:41
