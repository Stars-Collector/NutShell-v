...
module Prefetcher(	// src/main/scala/system/Prefetcher.scala:32:7
  ...
  assign io_out_valid_0 =
    getNewReq
      ...
      : io_in_valid;	// src/main/scala/nutcore/NutCore.scala:86:{11,24,44}, :87:15, src/main/scala/system/Prefetcher.scala:32:7, :37:26, :38:28, :52:21, :54:18, :59:{18,21}
  ...
  `ifndef SYNTHESIS	// src/main/scala/system/Prefetcher.scala:65:11
    always @(posedge clock) begin	// src/main/scala/system/Prefetcher.scala:65:11
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset)	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/system/Prefetcher.scala:65:11
        $fwrite(32'h80000002,
                "%d: [Prefetcher]: in(%d,%d), out(%d,%d), in.bits.addr = %x\n", c,
                io_in_valid, io_in_ready_0, io_out_valid_0, io_out_ready,
                io_in_bits_addr);	// src/main/scala/system/Prefetcher.scala:52:21, :54:18, :55:17, :59:18, :60:17, :65:11, src/main/scala/utils/GTimer.scala:24:20
    end // always @(posedge)
  `endif // not def SYNTHESIS
  always @(posedge clock) begin	// src/main/scala/system/Prefetcher.scala:32:7
    if (reset) begin	// src/main/scala/system/Prefetcher.scala:32:7
      ...
      c <= 64'h0;	// src/main/scala/system/Prefetcher.scala:44:28, src/main/scala/utils/GTimer.scala:24:20
    end
      ...
      if (getNewReq)	// src/main/scala/system/Prefetcher.scala:37:26
        getNewReq <=
          ~(io_out_ready & io_out_valid_0
            | {prefetchReq_addr[31:30], ~(prefetchReq_addr[29:28])} == 4'h0
            | {prefetchReq_addr[31], ~(prefetchReq_addr[30])} == 2'h0);	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/nutcore/NutCore.scala:86:{11,24,44}, src/main/scala/system/Prefetcher.scala:32:7, :37:26, :38:28, :52:21, :54:18, :59:18, :61:{18,32}
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/system/Prefetcher.scala:32:7
    ...
    initial begin	// src/main/scala/system/Prefetcher.scala:32:7
      automatic logic [31:0] _RANDOM[0:7];	// src/main/scala/system/Prefetcher.scala:32:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/system/Prefetcher.scala:32:7
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          _RANDOM[i[2:0]] = `RANDOM;	// src/main/scala/system/Prefetcher.scala:32:7
        ...
        c = {_RANDOM[3'h5][31:16], _RANDOM[3'h6], _RANDOM[3'h7][15:0]};	// src/main/scala/system/Prefetcher.scala:32:7, :44:28, src/main/scala/utils/GTimer.scala:24:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
