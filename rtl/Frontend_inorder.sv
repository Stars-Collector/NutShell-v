  ...
  `ifndef SYNTHESIS	// src/main/scala/utils/Debug.scala:49:26
    always @(posedge clock) begin	// src/main/scala/utils/Debug.scala:49:26
      if ((`PRINTF_COND_) & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Frontend_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002,
                "------------------------ FRONTEND:------------------------\n");	// src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Frontend_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "flush = %b, ifu:(%d,%d), idu:(%d,%d)\n", _ifu_io_flushVec,
                _ifu_io_out_valid, _ibf_io_in_q_io_enq_ready, valid, _idu_io_in_0_ready);	// src/main/scala/nutcore/frontend/Frontend.scala:94:20, :96:20, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/FlushableQueue.scala:94:21, src/main/scala/utils/Pipeline.scala:24:24
      end
      if ((`PRINTF_COND_) & _ifu_io_out_valid & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/nutcore/frontend/Frontend.scala:94:20, src/main/scala/utils/Debug.scala:49:26, :50:15
        $fwrite(32'h80000002, "[%d] Frontend_inorder: ", _LogPerfHelper_timer);	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26
        $fwrite(32'h80000002, "IFU: pc = 0x%x, instr = 0x%x\n", _ifu_io_out_bits_pc,
                _ifu_io_out_bits_instr);	// src/main/scala/nutcore/frontend/Frontend.scala:94:20, src/main/scala/utils/Debug.scala:49:26, :50:15
      end
      if ((`PRINTF_COND_) & valid & _LogPerfHelper_logEnable & ~reset) begin	// difftest/src/main/scala/common/LogPerfControl.scala:60:79, src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:24:24
        ...
        $fwrite(32'h80000002, "IDU1: pc = 0x%x, instr = 0x%x, pnpc = 0x%x\n",
                idu_io_in_0_bits_rpc, idu_io_in_0_bits_rinstr, idu_io_in_0_bits_rpnpc);	// src/main/scala/utils/Debug.scala:49:26, :50:15, src/main/scala/utils/Pipeline.scala:30:28
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
